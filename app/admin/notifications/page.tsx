    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                {success && <div className="bg-brand-primary/5 text-brand-primary p-4 rounded-lg mb-4">{success}</div>}
                    ...
                    <div className="flex gap-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                className="w-5 h-5 text-brand-primary rounded focus:ring-brand-accent/25 cursor-pointer"
                            />
